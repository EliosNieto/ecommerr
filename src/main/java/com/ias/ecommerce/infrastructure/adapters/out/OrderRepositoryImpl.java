...
public class OrderRepositoryImpl implements OrderRepository {
    ...
    public OrderRepositoryImpl(OrderRepositoryJpa orderRepositoryJpa, ClientRepositoryJpa clientRepository, OrderMapper orderMapper, OrderDetailMapper orderDetailMapper) {
    ...
    public Optional<Order> save(Order order) {
        ...
        orderEntity.getDetailsEntities().forEach(orderDetailsEntity -> orderDetailsEntity.setOrderEntity(finalOrderEntity));
    ...
    public Optional<Order> update(Order order) {
        ...
        OrderEntity orderEntity = orderRepositoryJpa.findById(4).get();
        OrderEntity orderEntity2 = orderMapper.toOrderEntity(order);

        orderEntity2.setClientEntity(clientRepository.findById(1082959591).get());
        //orderEntity.getDetailsEntities().get(0).setAmount(10);

        ProductEntity productEntity = new ProductEntity();
        productEntity.setProductId(11);
        ...
        orderDetailsEntity.setOrderProductPK(new OrderProductPK(4,11));
